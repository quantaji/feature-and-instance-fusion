...
$HOME/.conda/envs/sp3/bin/python fusion.py --pipeline tsdf_feature --pipeline_device cuda:1 --start 0 --end 100 --stride 1 --save_dir $HOME/Experiments/feature-instance-fusion/debug --extractor gt_semantic --feat_dim 41 --gt_num_classes 41 --feature_dtype float32
...
$HOME/.conda/envs/sp3/bin/python fusion.py --pipeline gradslam_feature --pipeline_device cuda:1 --start 0 --end -1 --stride 30 --save_dir $HOME/Experiments/feature-instance-fusion/debug --extractor conceptfusion --feature_dtype float --extractor_device cuda:0 --save_extraction --output_height 240 --output_width 320
