...
# graph connect
$HOME/.conda/envs/feat-seg-fusion/bin/python fusion.py --pipeline graph_connect --pipeline_device cuda:0 --save_dir /scratch/quanta/Experiments/feature-instance-fusion-new/scannet_scene0000_00 --kmeans_cluster_num 1024 --kmeans_extractor random_grounded_sam --extractor grounded_sam --dataset_dir /scratch/quanta/Datasets/ScanNet --log_ratio_threshold 1.5 --positive_threshold 0.3
