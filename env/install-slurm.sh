...
# open3d, headless rendering version
${SCRATCH}/.python_venv/feat-seg-fusion/bin/pip3 install "https://github.com/quantaji/open3d-manylinux2014/releases/download/5b6ef4/open3d_cpu-0.17.0-0headless-cp310-cp310-manylinux_2_17_x86_64.whl"
